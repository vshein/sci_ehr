DROP TABLE IF EXISTS miii_demo_coh_concepts.admission_service;

CREATE TABLE miii_demo_coh_concepts.admission_service AS
...
WITH categorized AS (
    ...
    LEFT JOIN miii_demo_coh.services s
