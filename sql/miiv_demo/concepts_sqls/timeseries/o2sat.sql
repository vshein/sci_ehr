DROP TABLE IF EXISTS miiv_demo_coh_concepts.o2sat;
CREATE TABLE miiv_demo_coh_concepts.o2sat AS
SELECT
    cw.subject_id,
    cw.hadm_id,
    cw.stay_id,
...
WHERE src.itemid IN (220277|226253|220227)
