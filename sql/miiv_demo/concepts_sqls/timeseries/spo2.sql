DROP TABLE IF EXISTS miiv_demo_coh_concepts.spo2;
CREATE TABLE miiv_demo_coh_concepts.spo2 AS
SELECT
    cw.subject_id,
    cw.hadm_id,
    cw.stay_id,
    ...
    (CAST(src.valuenum AS NUMERIC) - 32) * 5.0/9.0 AS value,
...
JOIN miiv_demo_coh.chartevents src
...
WHERE src.itemid IN (220277|226253)
