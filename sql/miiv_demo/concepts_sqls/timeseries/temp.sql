DROP TABLE IF EXISTS miiv_demo_coh_concepts.temp;
CREATE TABLE miiv_demo_coh_concepts.temp AS
SELECT
    cw.subject_id,
    cw.hadm_id,
    cw.stay_id,
...
WHERE src.itemid IN (223761|224027)
AND src.valuenum IS NOT NULL
AND src.charttime BETWEEN cw.hospital_start AND cw.hospital_end;
