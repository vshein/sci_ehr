DROP TABLE IF EXISTS miii_demo_coh_concepts.temp;
CREATE TABLE miii_demo_coh_concepts.temp AS
SELECT
    cw.subject_id,
    cw.hadm_id,
    cw.icustay_id,
...
WHERE src.itemid IN (676|677|223762)
...
WHERE src.itemid IN (678|679|223761|224027)
AND src.valuenum IS NOT NULL
AND src.charttime BETWEEN cw.hospital_start AND cw.hospital_end;
