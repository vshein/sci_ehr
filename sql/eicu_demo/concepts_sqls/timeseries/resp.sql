DROP TABLE IF EXISTS eicu_demo_coh_concepts.resp;
CREATE TABLE eicu_demo_coh_concepts.resp AS
SELECT
    cw.uniquepid,
    ...
    CAST(src.respiration AS NUMERIC) AS value,

    'insp/min' AS unit,

    src.respiration AS value_raw,
...
WHERE src.respiration IS NOT NULL;
