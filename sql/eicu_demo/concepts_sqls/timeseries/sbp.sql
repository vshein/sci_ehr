DROP TABLE IF EXISTS eicu_demo_coh_concepts.sbp;
CREATE TABLE eicu_demo_coh_concepts.sbp AS
SELECT
    cw.uniquepid,
    ...
    CAST(src.systemicsystolic AS NUMERIC) AS value,

    'mmHg' AS unit,

    src.systemicsystolic AS value_raw,
...
WHERE src.systemicsystolic IS NOT NULL;
