DROP TABLE IF EXISTS eicu_demo_coh_concepts.start;
CREATE TABLE eicu_demo_coh_concepts.start AS
SELECT
    cw.uniquepid,
    ...
    CAST(src.ventstartoffset AS NUMERIC) AS value,

    'NA' AS unit,

    src.ventstartoffset AS value_raw,
...
WHERE src.ventstartoffset IS NOT NULL
UNION ALL
SELECT
    cw.uniquepid,
    cw.patienthealthsystemstayid,
    ...
    CAST(src.priorventstartoffset AS NUMERIC) AS value,

    'NA' AS unit,

    src.priorventstartoffset AS value_raw,
...
WHERE src.priorventstartoffset IS NOT NULL
UNION ALL
SELECT
    cw.uniquepid,
    cw.patienthealthsystemstayid,
